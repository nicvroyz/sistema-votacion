...
CREATE DATABASE IF NOT EXISTS sisvotacion_db;
USE sisvotacion_db;

-- Crear usuario
CREATE USER 'user_db'@'localhost' IDENTIFIED BY 'sisvotacion23';

-- Asignar permisos en la base de datos
GRANT ALL PRIVILEGES ON sisvotacion_db.* TO 'user_db'@'localhost';

-- Recargar privilegios 
FLUSH PRIVILEGES;

-- Eliminar tabla comunas si ya existe
...
-- Eliminar tabla provincias si ya existe
...
-- Eliminar tabla regiones si ya existe
...
INSERT INTO candidatos (nombre, partido, descripcion) VALUES
('José Antonio Kast', 'Republicano', 'Enfoque en temas de seguridad, inmigracion y valores conservadores.'),
('Sebastián Sichel', 'Independiente', 'Enfoque politico y sus propuestas aborda temas de interés tanto de la derecha como de la centroizquierda'),
('Yasna Provoste', 'DC', 'Enfoque en temas como la educacion, la igualdad social y la justicia.'),
('Franco Parisi', 'Partido Gente', 'Enfoque en temas economicos y su defensa de politicas que promuevan la libre competencia y la eficiencia economica.'),
('Marco Enriquez-Ominami', 'Patria Progresista', 'Enfoque en justicia social, la igualdad de género y la protección del medio ambiente.'),
('Gabriel Boric', 'Frente Amplio', 'Enfoque en temas progresistas, incluyendo la justicia social, la igualdad de género y la sostenibilidad ambiental.'),
('Eduardo Artés', 'Union Patriotica', 'Enfoque en igualdad social, la justicia económica y la participación ciudadana.');
...
-- Insertar votante de ejemplo
INSERT INTO votantes (rut, nombre, region_id, comuna_id, candidato_id) VALUES
('12345678-9', 'Juan Pérez', 1, 1, 1);